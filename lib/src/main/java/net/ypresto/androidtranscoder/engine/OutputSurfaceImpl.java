 ...
 */
public class OutputSurfaceImpl implements SurfaceTexture.OnFrameAvailableListener, OutputSurface {
     ...
     */
    public OutputSurfaceImpl(int width, int height) {
        if (width <= 0 || height <= 0) {
